...
{
    protected static function addStructureElements(Structure $structure)
    {
        if (!isset($structure->primaryKey))
        {
            throw new \LogicException(get_called_class() . '::addStructureElements() must be called after setting "primaryKey" property!');
        }
